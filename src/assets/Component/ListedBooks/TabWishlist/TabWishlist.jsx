      ...
      <div>

        {
            parsGetItem?.map(item => (
                ...
                <div key={item.bookId} className="card card-side bg-base-100 shadow-xl border border-gray-300 my-10 ">
                  <figure>
                    <img
                      src={ item.image }
                      alt="Movie"
                  ...
                  <div className="card-body">
                    <div className="border-b border-gray-300 space-y-1">
                      ...
                      <div className='flex justify-start' >
                        <p> <span className="font-semibold text-xl"> Tag </span>: taggg  </p>
                      <p>
