        ...
        <div className="grid items-center grid-cols-1 md:grid-cols-2">
            ...
            <div>
                ...
                <p className="mt-4 text-xl text-gray-600 dark:text-gray-300 md:mt-8">
                    ...
                    <br className="block sm:hidden" />Ask me on <a href="/contact" title=""
                        className="transition-all duration-200 text-sky-500 dark:text-sky-400 hover:text-sky-600 dark:hover:text-sky-500 hover:underline">Contact</a>
                </p>
            </div>
